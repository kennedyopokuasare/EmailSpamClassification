            ...
            for mail in emails:
                ...
                with open(mail) as m:
                    ...
                    for word in all_words:
                        print "extracting weight of words"
                        wordID = 0
                        if word in dictionary:
                            print "setting weight value"
                           
                            wordID = dictionary.index(word[0])
                            weight=all_words.count(word)
                            print weight
                            features_matrix[docID,wordID] = weight
